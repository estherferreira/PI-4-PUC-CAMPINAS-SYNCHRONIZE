...
import com.synback.repositories.GenericRepository;
...
public class DiagnosticsService {
    ...
    private final GenericRepository<User, String> userRepository;
    private final GenericRepository<Diagnosis, String> diagnosisRepository;
    private static final String OPENAI_API_KEY = System.getenv("PUBLIC_API_KEY");

    public DiagnosticsService(GenericRepository<User, String> userRepository,
            GenericRepository<Diagnosis, String> diagnosisRepository) {
